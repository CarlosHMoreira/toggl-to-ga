...
export const getStartDate = (row: TogglRow) => new Date(`${row['Start date']}T${row['Start time']}`);
export const getEndDate = (row: TogglRow) => new Date(`${row['End date']}T${row['End time']}`);
